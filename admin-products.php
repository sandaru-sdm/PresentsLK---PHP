        ...
        <div class="content-wrapper">
            ...
            <div class="card text-center col-10 d-flex align-content-center justify-content-center container-fluid">
                ...
                <div class="card-body">
                    ...
                    <a href="admin-addProduct.php" class="btn btn-primary col-6">Add Products</a>
                </div>
                                ...
                                for($x=0; $x < $product_num; $x++){
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="<?php echo $image_data["code"]; ?>"
                                                ...
                                                <td><?php echo $product_data["condition"]; ?></td>
                                                <td id="status"><?php echo $status_data["name"]; ?></td>
                                                <td class="text-center"><button class="btn btn-success col-12 mx-1 my-1"><a
                                                            href="updateProducts.php?id=<?php echo $product_data['id']; ?>"
                                                            class="text-light" style="text-decoration: none;"> Update Product
                                                            </a></button>
                                                            <br>
                                                            <button
                                                        class="btn btn-danger col-12 mx-1 my-1"
