...
<head>
    ...
    <title>PresentsLK | Add Carousel</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="admin-carousel.php">Carousel</a></li>
                                ...
                                <div class="card-body col-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12">
                                            <label for="exampleInputFile">Select Carousel Image</label>
                                ...
                                <div class="card-footer mb-4">
                                    <div class="d-grid gap-2 col-6 mx-auto">
                                        <button type="submit" class="btn btn-primary col-12 " name="submit" id="submit"
                                            onclick="addCarousel();">Submit</button>
                                    </div>
                                </div>
