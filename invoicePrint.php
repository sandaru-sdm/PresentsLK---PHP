...
<head>
    ...
    <title>PresentLK | Invoice Print</title>
...
<body>
    <div class="container-fluid col-11 justify-content-center align-items-center d-flex">
        <div class="wrapper">
            <!-- Main content -->
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="page-header">
                            ...
                            <small class="float-right">Date: 05/07/2022</small>
                        </h2>
                    </div>
                    <!-- /.col -->
                </div>
